<?php 
    ...
    if(isset($_SESSION["id"])){
        ...
        if(is_object($conectarBanco)){
            $stmt = $conectarBanco->prepare("CALL consultarProduto(?)");
            ...
            if($stmt->rowCount() > 0){
                ...
                $conectarBanco = null;
                $_SESSION["mensagemConclusao"] = "Produto inexistente.";
    ...
    <main class="conteudoPrincipal">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" id="formulario">
            <div class="areaEntradaDados">
                ...
                <input type="text" name="nome" id="campoNome" class="campoEntradaDados" placeholder="Informe o novo nome do produto" value="<?php echo $nome; ?>" maxlength="30" required>
            </div>
            <div class="areaEntradaDados">
            ...
            <div class="areaEntradaDados">
                ...
                <input type="number" name="preco" id="campoPreco" class="campoEntradaDados" placeholder="Informe o novo preço do produto" value="<?php echo $preco; ?>" min="1" max="999.99" step=".01" required>
            </div>
